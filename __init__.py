...
try:
    ...
    from .t5gemma_model_loader_s import NODE_CLASS_MAPPINGS as T5GEMMA_MODEL_LOADER_S_MAPPINGS
    from .t5gemma_model_loader_s import NODE_DISPLAY_NAME_MAPPINGS as T5GEMMA_MODEL_LOADER_S_DISPLAY_MAPPINGS
    ...
    from .t5gemma_text_encode_v2 import NODE_CLASS_MAPPINGS as T5GEMMA_TEXT_ENCODE_V2_MAPPINGS
    from .t5gemma_text_encode_v2 import NODE_DISPLAY_NAME_MAPPINGS as T5GEMMA_TEXT_ENCODE_V2_DISPLAY_MAPPINGS
...
all_class_mappings = [
    ...
    T5GEMMA_MODEL_LOADER_S_MAPPINGS,
    ...
    T5GEMMA_TEXT_ENCODE_V2_MAPPINGS,
]
...
all_display_mappings = [
    ...
    T5GEMMA_MODEL_LOADER_S_DISPLAY_MAPPINGS,
    ...
    T5GEMMA_TEXT_ENCODE_V2_DISPLAY_MAPPINGS,
]
